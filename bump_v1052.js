// Web-only version bump: v1051 -> v1052 (Multi-currency enable toggle).
// Adds a "Πολλαπλά Νομίσματα" toggle in Settings that calls
// CurrencyService.setEnabled(true), so the fully-implemented multi-currency
// architecture (currency row, currency picker, display currency, net worth row)
// finally becomes visible. Previously the feature was gated behind the
// localStorage flag `multi_currency_enabled` but there was NO way to turn it on.
//
