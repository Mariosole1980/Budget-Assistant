// Web-only version bump: v1046 -> v1047 (multi-currency implementation).
// OTAEngine.js BUNDLED_NATIVE_VERSION is intentionally left at 1046 because the
// APK is not being rebuilt (web-only change). The Android/iOS app will OTA-download
// the new app.js (multi-currency support), so the native layout is unaffected.
const fs = require('fs');
