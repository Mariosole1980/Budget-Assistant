// Web-only version bump: v1052 -> v1053 (Country-based currency search).
// Enriches CurrencyService with a full country+currency catalog (flags +
// countries arrays) and improves the currency picker search so typing a
// country or currency name opens the matching countries with their flags
// and currencies.
//
