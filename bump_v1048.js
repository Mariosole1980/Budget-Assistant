// Web-only version bump: v1047 -> v1048 (CurrencyService self-sufficiency fix).
// This forces the OTA engine to re-download app.js because the previous v1047
// build was broken (CurrencyService not defined on older APKs). Since the OTA
// engine only updates when remoteVersion > currentVersion, we MUST bump the
// version so devices stuck on the broken v1047 re-download the fixed app.js.
