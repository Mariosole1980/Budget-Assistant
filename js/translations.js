...
(function (root, factory) {
    ...
    const TRANSLATIONS = {
      el: {
        ...
        "sts_bar_title": "Ημερήσιο Περιθώριο",
        "sts_bar_action": "Ανάλυση",
        "sts_status_healthy": "Εντός στόχου",
        "sts_status_caution": "Προσοχή",
        "sts_status_critical": "Υπέρβαση",
        "sts_savings_goal_row_label": "- Στόχος Αποταμίευσης (Ετήσια βάση):",
        "sts_savings_target_title": "Στόχος Αποταμίευσης (Ετήσια Βάση)",
        "sts_savings_target_desc": "Ορίστε το μηνιαίο ποσό αποταμίευσης. Συγχρονίζεται αυτόματα με τον Ετήσιο Στόχο Αποταμίευσης (ποσό x 12) στην Επισκόπηση και προστατεύεται από το ημερήσιο όριο εξόδων.",
        "sts_savings_set_btn": "Ορισμός",
        "sts_savings_edit_btn": "Αλλαγή",
        "sts_savings_save_btn": "Αποθήκευση",
        "sts_savings_saved_toast": "Ο μηνιαίος στόχος αποταμίευσης ορίστηκε σε",
        "sts_sim_one_off": "Εφάπαξ",
        "sts_sim_3_installments": "3 Δόσεις",
        "sts_sim_6_installments": "6 Δόσεις",
        "nav_trans": "Κινήσεις",
        ...
        "settings_recurring_desc": "Προγραμματισμένα έξοδα, έσοδα & πάγιες εντολές",
                "settings_accounts_option": "Διαχείριση Πορτοφολιών",
        "settings_accounts_desc": "Τράπεζες, Κάρτες, Μετρητά & Επενδύσεις",
        "accounts_title": "Διαχείριση Πορτοφολιών",
        "accounts_subtitle": "Τράπεζες, Κάρτες, Μετρητά & Επενδύσεις",
        "accounts_add_account": "Νέο Πορτοφόλι",
        "accounts_edit_account": "Επεξεργασία Πορτοφολιού",
        "account_type_cash": "Μετρητά",
        "account_type_bank": "Τραπεζικός Λογαριασμός",
        "account_type_card": "Κάρτα",
        "account_type_investment": "Επένδυση / Χαρτοφυλάκιο",
        "account_name_label": "Όνομα Πορτοφολιού",
        "account_name_placeholder": "π.χ. Eurobank, Μετρητά, Revolut, Degiro",
        "account_initial_balance": "Αρχικό Υπόλοιπο",
        "account_currency": "Νόμισμα",
        "account_delete_confirm": "Είσαι σίγουρος ότι θέλεις να διαγράψεις το πορτοφόλι;",
        "account_deleted": "Το πορτοφόλι διαγράφηκε",
        "account_saved": "Το πορτοφόλι αποθηκεύτηκε",
        "account_picker_new": "+ Νέο Πορτοφόλι...",
        "account_picker_title": "Επιλογή τρόπου πληρωμής",
        "account_picker_bank_transfer": "🏦 Μεταφορά σε Τράπεζα:",
        "account_other_bank": "Άλλη Τράπεζα",
        ...
        "settings_rate_title": "Αξιολόγηση στο Play Store",
        "settings_rate_desc": "Βαθμολογήστε μας και βοηθήστε την ανάπτυξη",
        "review_prompt_title": "Σας αρέσει το Budget Assistant;",
        "review_prompt_desc": "Η γνώμη σας μας βοηθά να εξελίσσουμε την εφαρμογή! Θα θέλατε να μας αφήσετε μια σύντομη αξιολόγηση στο Google Play Store;",
        "review_btn_rate": "⭐ Αξιολόγηση στο Play Store",
        "review_btn_later": "Υπενθύμιση αργότερα",
        "review_btn_dismiss": "Όχι, ευχαριστώ",
        ...
        "item_budget_limit_alerts": "Όρια Προϋπολογισμών (80% & 100%)",
        "item_budget_limit_alerts_desc": "Ειδοποίηση όταν ένα έξοδο πλησιάζει ή ξεπερνά το όριο κατηγορίας",
        "item_bank_notifications": "Αυτόματη Καταγραφή από Τράπεζες",
        "item_bank_notifications_desc": "Αναγνώριση κινήσεων από Eurobank, Εθνική, Πειραιώς, Alpha, Revolut",
        ...
        "item_quick_add_notification": "Γρήγορη καταχώρηση",
        "voice_ai_title": "Οικονομικός Βοηθός",
        "voice_ai_listening": "Σας ακούω... Πείτε π.χ. «30€ βενζίνη από Alpha Bank»",
        "voice_ai_processing": "Επεξεργασία με AI…",
        "voice_ai_ready": "Έτοιμο!",
        "voice_ai_btn_done": "Ολοκλήρωση",
        "voice_ai_btn_cancel": "Ακύρωση",
        "voice_ai_btn_retry": "Επανάληψη",
        "voice_ai_placeholder": "Ή πληκτρολογήστε τη συναλλαγή εδώ…",
        "voice_ai_not_supported": "Η αναγνώριση ομιλίας δεν υποστηρίζεται σε αυτό το πρόγραμμα. Μπορείτε να πληκτρολογήσετε παρακάτω.",
        ...
        "app_version": "Έκδοση 1.0.0 (build v1735 - 06/08/2026)",
        ...
        "forecast_modal_title": "🛡️ Στόχος Αποταμίευσης & Μαξιλάρι",
        ...
        "advisor_chat_title": "Οικονομικός Βοηθός",
        "header_assistant_btn": "Βοηθός",
        "settings_group_financial": "Οικονομικά Εργαλεία",
        "settings_group_preferences": "Προτιμήσεις & Οικογένεια",
        "settings_group_security_data": "Ασφάλεια & Δεδομένα",
        "settings_group_support": "Λογαριασμός & Υποστήριξη",
        ...
        "advisor_placeholder": "Ρωτήστε για έξοδα, αγορές, προϋπολογισμό...",
        ...
        "premium_plan_desc": "Εφάπαξ πληρωμή 9,99€ για τους 100 πρώτους — μετά 29,99€ Lifetime.",
        "premium_early_bird_badge": "Προσφορά Πρώτων 100 Χρηστών:",
        "premium_early_bird_text": " 9,99€ εφάπαξ Lifetime (κατόπιν 29,99€)!",
        "premium_for_first_100": "(Μόνο για τους πρώτους 100)",
        ...
        "advisor_chat_placeholder": "Ρωτήστε για έξοδα, αγορές, προϋπολογισμό...",
        ...
        "auto_lock_immediate": "Άμεσα",
        "auto_lock_immediate_sub": "Κλείδωμα κατά την έξοδο ή εναλλαγή εφαρμογής",
        "auto_lock_requires_pin": "Πρέπει πρώτα να ορίσετε ένα 4ψήφιο PIN!",
        "auto_lock_toast_enabled": "Το αυτόματο κλείδωμα ενεργοποιήθηκε",
        "auto_lock_toast_disabled": "Το αυτόματο κλείδωμα απενεργοποιήθηκε",
        ...
        "item_quick_add_notification_desc": "Εμφάνιση εργαλείων Budget Assistant στη γραμμή ειδοποιήσεων",
      ...
      en: {
        ...
        "ai_check_btn": "Check",
        "sts_bar_title": "Daily Allowance",
        "sts_bar_action": "Analysis",
        "sts_status_healthy": "On Track",
        "sts_status_caution": "Caution",
        "sts_status_critical": "Over Budget",
        "sts_savings_goal_row_label": "- Savings Goal (Annual basis):",
        "sts_savings_target_title": "Savings Goal (Annual Basis)",
        "sts_savings_target_desc": "Set your monthly savings goal. This syncs automatically with your Annual Savings Goal (amount x 12) in Overview and is protected from daily spending allowance.",
        "sts_savings_set_btn": "Set",
        "sts_savings_edit_btn": "Edit",
        "sts_savings_save_btn": "Save",
        "sts_savings_saved_toast": "Monthly savings goal updated to",
        "sts_sim_one_off": "One-off",
        "sts_sim_3_installments": "3 Installments",
        "sts_sim_6_installments": "6 Installments",
        ...
        "settings_recurring_desc": "Scheduled expenses, income & recurring rules",
                "settings_accounts_option": "Wallet Manager",
        "settings_accounts_desc": "Banks, Cards, Cash & Investments",
        "accounts_title": "Wallet Manager",
        "accounts_subtitle": "Banks, Cards, Cash & Investments",
        "accounts_add_account": "New Wallet",
        "accounts_edit_account": "Edit Wallet",
        "account_type_cash": "Cash",
        "account_type_bank": "Bank Account",
        "account_type_card": "Card",
        "account_type_investment": "Investment / Portfolio",
        "account_name_label": "Wallet Name",
        "account_name_placeholder": "e.g. Eurobank, Revolut, Degiro",
        "account_initial_balance": "Initial Balance",
        "account_currency": "Currency",
        "account_delete_confirm": "Are you sure you want to delete this wallet?",
        "account_deleted": "Wallet deleted",
        "account_saved": "Wallet saved",
        "account_picker_new": "+ New Wallet...",
        "account_picker_title": "Select Payment Method",
        "account_picker_bank_transfer": "🏦 Transfer to Bank:",
        "account_other_bank": "Other Bank",
        ...
        "settings_rate_title": "Rate on Play Store",
        "settings_rate_desc": "Rate us and support our development",
        "review_prompt_title": "Enjoying Budget Assistant?",
        "review_prompt_desc": "Your feedback helps us continuously improve! Would you take a moment to leave a review on Google Play Store?",
        "review_btn_rate": "⭐ Rate on Play Store",
        "review_btn_later": "Remind me later",
        "review_btn_dismiss": "No, thanks",
        ...
        "item_budget_limit_alerts": "Budget Limit Alerts (80% & 100%)",
        "item_budget_limit_alerts_desc": "Alert when spending approaches or exceeds category limit",
        "item_bank_notifications": "Bank Push Notifications",
        "item_bank_notifications_desc": "Automatic capture from Greek banks & Revolut",
        ...
        "item_quick_add_notification": "Quick Add",
        "voice_ai_title": "Financial Assistant",
        "voice_ai_listening": "Listening... Say e.g. «30€ gas from Alpha Bank»",
        "voice_ai_processing": "Processing with AI…",
        "voice_ai_ready": "Ready!",
        "voice_ai_btn_done": "Done",
        "voice_ai_btn_cancel": "Cancel",
        "voice_ai_btn_retry": "Retry",
        "voice_ai_placeholder": "Or type your transaction here…",
        "voice_ai_not_supported": "Speech recognition is not supported in this browser. You can type below.",
        ...
        "section_legal": "Legal",
        "app_version": "Version 1.0.0 (build v1735 - 06/08/2026)",
        ...
        "forecast_modal_title": "🛡️ Savings Goal & Runway",
        ...
        "advisor_chat_title": "Financial Copilot",
        "header_assistant_btn": "Assistant",
        "settings_group_financial": "Financial Tools",
        "settings_group_preferences": "Preferences & Family",
        "settings_group_security_data": "Security & Data",
        "settings_group_support": "Account & Support",
        ...
        "advisor_placeholder": "Ask about expenses, purchases, budgets...",
        ...
        "auto_lock_immediate": "Immediately",
        "auto_lock_immediate_sub": "Locks upon exiting or switching apps",
        "auto_lock_requires_pin": "Please set a 4-digit PIN first!",
        "auto_lock_toast_enabled": "Auto-lock activated",
        "auto_lock_toast_disabled": "Auto-lock disabled",
        ...
        "item_quick_add_notification_desc": "Show Budget Assistant tools in notification shade",
        ...
        "premium_plan_name": "Lifetime PRO",
        "premium_plan_desc": "One-time payment €9.99 for the first 100 users — then €29.99 Lifetime.",
        "premium_early_bird_badge": "First 100 Users Offer:",
        "premium_early_bird_text": " €9.99 one-time Lifetime (then €29.99)!",
        "premium_for_first_100": "(First 100 users only)",
        ...
        "advisor_chat_placeholder": "Ask about expenses, purchases, budgets...",
