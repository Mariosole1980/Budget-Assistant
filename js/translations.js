 ...
 *
 * UMD wrapper (same proven pattern as js/transactionMerge.js / js/constants.js):
 *   - Node / CommonJS: module.exports (used by node:test)
 *   - Browser: window.TRANSLATIONS global (so app.js bare references AND
 *     web-ui.js's window.TRANSLATIONS access both work with zero changes)
 *
...
(function (root, factory) {
    ...
    // ============================================================
    // TRANSLATIONS: { el: {...}, en: {...} }
    // Extracted verbatim from app.js (no logic changes).
    // ============================================================
    const TRANSLATIONS = {
      el: {
        nav_trans: 'Κινήσεις',
        ...
        app_version: 'Έκδοση 1.0.0 (build v1330 - 06/08/2026)',
      ...
      en: {
        ...
        section_legal: 'Legal',
        app_version: 'Version 1.0.0 (build v1330 - 06/08/2026)',
