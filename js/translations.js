    ...
    const TRANSLATIONS = {
      el: {
        ...
        "settings_recurring_desc": "Προγραμματισμένα έξοδα, έσοδα & πάγιες εντολές",
                "settings_accounts_option": "Διαχείριση Λογαριασμών",
        "settings_accounts_desc": "Τράπεζες, Κάρτες, Μετρητά & Επενδύσεις",
        "accounts_title": "Διαχείριση Λογαριασμών",
        "accounts_subtitle": "Τράπεζες, Κάρτες, Μετρητά & Επενδύσεις",
        "accounts_add_account": "Νέος Λογαριασμός",
        "accounts_edit_account": "Επεξεργασία Λογαριασμού",
        ...
        "account_name_placeholder": "π.χ. Eurobank, Revolut, Degiro",
        "account_initial_balance": "Αρχικό Υπόλοιπο",
        "account_currency": "Νόμισμα",
        "account_delete_confirm": "Είσαι σίγουρος ότι θέλεις να διαγράψεις τον λογαριασμό;",
        "account_deleted": "Ο λογαριασμός διαγράφηκε",
        "account_saved": "Ο λογαριασμός αποθηκεύτηκε",
        "account_picker_new": "+ Νέος Λογαριασμός...",
        "account_picker_title": "Επιλογή Λογαριασμού",
      ...
      en: {
        ...
        "settings_recurring_desc": "Scheduled expenses, income & recurring rules",
                "settings_accounts_option": "Account Manager",
        ...
        "accounts_add_account": "New Account",
        "accounts_edit_account": "Edit Account",
        ...
        "account_picker_new": "+ New Account...",
        "account_picker_title": "Select Account",
