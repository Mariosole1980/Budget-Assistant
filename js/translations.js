...
(function (root, factory) {
    ...
    const TRANSLATIONS = {
      el: {
        ...
        "photo_picker_title": "Προσθήκη Φωτογραφίας / Απόδειξης",
        "photo_picker_ai_scan": "⚡ Σάρωση Απόδειξης με AI",
        "photo_picker_ai_scan_desc": "Αυτόματη ανάγνωση ποσού, καταστήματος & κατηγορίας",
        "photo_picker_camera": "📸 Απλή Λήψη με Κάμερα",
        "photo_picker_gallery": "🖼️ Επιλογή από Συλλογή",
      ...
      en: {
        ...
        "photo_picker_title": "Add Receipt / Photo",
        "photo_picker_ai_scan": "⚡ Scan Receipt with AI",
        "photo_picker_ai_scan_desc": "Auto-extract amount, merchant & category",
        "photo_picker_camera": "📸 Take Simple Photo",
        "photo_picker_gallery": "🖼️ Choose from Gallery",
