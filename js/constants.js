...
(function (root, factory) {
    ...
    const DEFAULT_SUBCATEGORIES_MAP = {
        ...
        'ΣΠΙΤΙ': ['Vodafone', 'ΔΕΗ', 'ΕΥΔΑΠ', 'Στεγαστικό Δάνειο', 'Συντήρηση Σπιτιού', 'Συσκευές Σπιτιού', 'Έπιπλα/Διακόσμηση', 'Οικιακά Είδη', 'Ενοίκιο', 'Κοινόχρηστα', 'Internet / Τηλέφωνο', 'Θέρμανση / Αέριο'],
        '🏡 ΣΠΙΤΙ': ['Vodafone', 'ΔΕΗ', 'ΕΥΔΑΠ', 'Στεγαστικό Δάνειο', 'Συντήρηση Σπιτιού', 'Συσκευές Σπιτιού', 'Έπιπλα/Διακόσμηση', 'Οικιακά Είδη', 'Ενοίκιο', 'Κοινόχρηστα', 'Internet / Τηλέφωνο', 'Θέρμανση / Αέριο'],
        '🏠 ΣΠΙΤΙ': ['Vodafone', 'ΔΕΗ', 'ΕΥΔΑΠ', 'Στεγαστικό Δάνειο', 'Συντήρηση Σπιτιού', 'Συσκευές Σπιτιού', 'Έπιπλα/Διακόσμηση', 'Οικιακά Είδη', 'Ενοίκιο', 'Κοινόχρηστα', 'Internet / Τηλέφωνο', 'Θέρμανση / Αέριο'],
