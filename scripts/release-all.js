...
console.log('[STEP 1/5] Bumping version...');
...
console.log('[STEP 2/5] Running version consistency check...');
try {
...
// Step 3: Deploy web to the canonical Cloudflare Pages project
console.log('[STEP 3/5] Deploying web to Cloudflare Pages...');
const wranglerPath = process.platform === 'win32' ? 'cmd /c npx wrangler' : 'npx wrangler';

console.log('  [DEPLOY] budget-assistant-pwa (canonical)...');
...
console.log('  [PASS] Web deployment complete.\n');
