// Web-only version bump: v1139 -> v1140 (Fix double icon-emoji in budget category
// rows and remove redundant notepad emoji from the More -> Notepad row).
//
// OTAEngine.js BUNDLED_NATIVE_VERSION is intentionally left unchanged (no APK rebuild).
const fs = require('fs');
...
console.log(`\nWeb version bumped from v${OLD} to v${NEW}. OTAEngine.js BUNDLED_NATIVE_VERSION left unchanged (no APK rebuild).`);
