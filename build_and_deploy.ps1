...
git add -A
git commit -m "build v${newBuild}: Fix More screen settings rows being cut off - prevent settings hub card from shrinking so the Account & Legal row is visible"
