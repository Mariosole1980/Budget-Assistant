...
6. ΠΡΟΣΟΜΟΙΩΣΗ ΑΓΟΡΑΣ / WHAT-IF (π.χ. 'μπορώ να πάρω laptop 600€;', 'με παίρνει να αγοράσω...;', 'αν πάρω ένα κινητό...;'):
   - Έλεγξε το πεδίο 'safeToSpend' στα στατιστικά.
   - Αν υπάρχει:
     * Συνολικό Ελεύθερο Ποσό Μήνα: discretionaryPool (μετά από μελλοντικές πάγιες εντολές).
     * Τρέχον ημερήσιο όριο: safeDaily€/ημέρα (απομένουν daysRemaining ημέρες).
     * Υπολόγισε το νέο ημερήσιο όριο: (discretionaryPool - ποσό_αγοράς) / daysRemaining.
